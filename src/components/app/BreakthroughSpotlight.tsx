      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl font-bold text-royalBlue mb-2 flex items-center justify-center">
            <Lightbulb className="mr-2 text-brightTeal" /> Breakthrough
            Spotlight
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover revolutionary pharmaceutical innovations that could
            transform medicine and create exceptional investment opportunities.
          </p>
        </motion.div>
